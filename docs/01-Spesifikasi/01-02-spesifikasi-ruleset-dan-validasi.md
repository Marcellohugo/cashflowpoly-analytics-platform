...
Bagian ini merangkum endpoint yang menangani *ruleset*. Dokumen kontrak lengkap berada pada [Kontrak REST API dan Event Permainan](../02-Perancangan/02-02-kontrak-rest-api-dan-event-permainan.md).
