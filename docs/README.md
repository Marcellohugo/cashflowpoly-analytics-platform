...
Status sinkronisasi terakhir: **12 Juli 2026**, baseline schema **3.0.6**. Kontrak payload/event aktif berada pada `02-Perancangan/02-02-rancangan-kontrak-api-dan-event.md`; skrip `database/00_create_schema.sql` tetap menjadi acuan teknis terakhir bila ada perbedaan.
