...
internal static class ApiErrorHelper
{
    ...
    private static readonly FrozenDictionary<string, string> IdToEnMessages = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["refreshSequences harus berisi maksimal 100 nomor urutan"] = "refreshSequences must contain at most 100 sequence numbers",
        ["Payload harus berupa objek JSON"] = "Payload must be a JSON object",
        ["Sesi belum dapat diakhiri: periksa status, kelengkapan donasi, dan penyelesaian risiko kehidupan"] = "The session cannot end yet: check its status, pending donations, and unresolved life risks",
        ["Cursor event tidak valid"] = "Invalid event cursor",
        ["Cursor atau batas riwayat undo tidak valid"] = "Invalid undo history cursor or limit",
        ["client_request_id undo sudah dipakai untuk permintaan lain"] = "The undo client_request_id is already used for another request",
        ["Undo hanya tersedia saat sesi sedang berjalan"] = "Undo is only available for a running session",
        ["Event sudah dibatalkan"] = "The event has already been undone",
        ["Event tidak ditemukan"] = "Event not found",
        ["Pembagian awal tidak dapat dibatalkan melalui undo event"] = "Initial setup cannot be reverted through event undo",
        ["State sesi berubah; muat ulang sebelum undo"] = "Session state has changed; reload before undoing",
        ["Hanya aktivitas terakhir yang dapat dibatalkan"] = "Only the latest activity can be undone",
        ["Event ini belum memiliki snapshot sebelum aktivitas"] = "This event has no snapshot from before the activity",
        ...
        ["Nama sesi maksimal 120 karakter"] = "Session name must be at most 120 characters",
        ["Struktur definition ruleset tidak valid"] = "Invalid ruleset definition structure",
        ["Elemen event batch tidak boleh null"] = "Batch event items cannot be null",
        ["Daftar pemain sudah terkunci. Muat ulang sesi untuk melihat pembagian awal terbaru."] = "The player roster is locked. Reload the session to view the latest setup.",
        ["Daftar pemain atau set aturan berubah. Muat ulang sesi sebelum menyimpan pembagian awal."] = "The player roster or ruleset has changed. Reload the session before saving its setup.",
        ...
        ["Kata sandi baru tidak boleh sama dengan kata sandi saat ini"] = "New password cannot be the same as current password",
        ["Kata sandi saat ini salah"] = "Current password is incorrect",
        ["Konfirmasi kata sandi baru tidak sama"] = "New password confirmation does not match",
        ["Pengguna tidak ditemukan atau tidak aktif"] = "User not found or inactive",
        ["Semua isian kata sandi wajib diisi"] = "All password fields are required",
        ...
        ["Pemain tidak ditemukan dalam sesi Anda"] = "Player was not found in your sessions",
        ["Pilih satu mode dan status sesi yang valid"] = "Select one valid game mode and session status",
        ...
        ["Sesi harus berstatus STARTED untuk menerima event"] = "Session must be STARTED to accept events",
        ["Session belum memiliki ruleset ACTIVE yang valid"] = "Session does not have a valid ACTIVE ruleset",
        ["Sesi belum memiliki ruleset ACTIVE yang valid"] = "Session does not have a valid ACTIVE ruleset",
        ["Session belum memiliki ruleset aktif"] = "Session does not have an active ruleset",
        ["Sesi belum memiliki ruleset aktif"] = "Session does not have an active ruleset",
        ["Session sudah berakhir"] = "Session has already ended",
        ["Sesi sudah berakhir"] = "Session has already ended",
        ["Session sudah berakhir atau dihapus"] = "Session has already ended or been deleted",
        ["Sesi sudah berakhir atau dihapus"] = "Session has already ended or been deleted",
        ...
        ["State sesi tidak ditemukan"] = "Session state not found",
        ...
        ["Token pengguna tidak valid"] = "Invalid user token",
