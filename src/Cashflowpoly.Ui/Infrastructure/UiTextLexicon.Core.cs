...
internal static partial class UiTextLexicon
{
    private static partial void AddCore(Dictionary<string, (string Id, string En)> terms)
    {
        ...
        terms["auth.password_hint"] = ("Gunakan minimal 12 karakter.", "Use at least 12 characters.");
        ...
        terms["auth.login_panel_desc"] = ("Masuk dengan akun Anda untuk melihat data permainan.", "Sign in with your account to view game data.");
        ...
        terms["auth.placeholder.full_name"] = ("Contoh: Hugo", "Example: Hugo");
        ...
        terms["auth.error.login_failed"] = ("Belum berhasil masuk. Periksa nama pengguna dan kata sandi, lalu coba lagi.", "Unable to sign in. Check your username and password, then try again.");
        ...
        terms["auth.error.login_response_invalid"] = ("Belum berhasil masuk. Silakan coba lagi.", "Unable to sign in. Please try again.");
        ...
        terms["auth.error.password_too_long"] = ("Kata sandi terlalu panjang. Gunakan kata sandi yang lebih pendek.", "Password is too long. Use a shorter password.");
        terms["auth.error.confirm_mismatch"] = ("Konfirmasi Kata Sandi tidak sama.", "Password confirmation does not match.");
        terms["auth.error.register_failed"] = ("Akun belum berhasil dibuat. Periksa isian Anda, lalu coba lagi.", "Unable to create your account. Check your details, then try again.");
        terms["auth.error.register_response_invalid"] = ("Pendaftaran belum dapat dikonfirmasi. Coba masuk dengan akun Anda sebelum mendaftar lagi.", "Registration could not be confirmed. Try signing in with your account before registering again.");
        terms["auth.change_password"] = ("Ubah Password", "Change Password");
        terms["auth.change_password_title"] = ("Ubah Password", "Change Password");
        terms["auth.change_password_subtitle"] = ("Perbarui kata sandi akun Anda untuk menjaga keamanan.", "Update your account password to maintain security.");
        terms["auth.account_security"] = ("Keamanan Akun", "Account Security");
        terms["auth.current_password"] = ("Kata Sandi Saat Ini", "Current Password");
        terms["auth.new_password"] = ("Kata Sandi Baru", "New Password");
        terms["auth.confirm_new_password"] = ("Konfirmasi Kata Sandi Baru", "Confirm New Password");
        terms["auth.change_password_submit"] = ("Simpan Password", "Save Password");
        terms["auth.changing_password"] = ("Menyimpan...", "Saving...");
        terms["auth.success.password_changed"] = ("Password berhasil diubah.", "Password changed successfully.");
        terms["auth.error.change_password_required"] = ("Semua isian kata sandi wajib diisi.", "All password fields are required.");
        terms["auth.error.password_same_as_current"] = ("Kata sandi baru tidak boleh sama dengan kata sandi saat ini.", "New password cannot be the same as current password.");
        ...
        terms["home.empty_workspace.title"] = ("Belum ada data permainan", "No game data yet");
        ...
        terms["common.loading"] = ("Memuat...", "Loading...");
