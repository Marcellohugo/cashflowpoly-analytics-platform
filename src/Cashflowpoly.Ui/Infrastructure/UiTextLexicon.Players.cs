...
internal static partial class UiTextLexicon
{
    private static partial void AddPlayers(Dictionary<string, (string Id, string En)> terms)
    {
        ...
        terms["players.analysis.net_worth.desc"] = ("Membandingkan Koin Saat Ini dengan Koin Awal. Tabungan, bahan, emas, dan aset lain tidak dihitung.", "Compares Coins Held Now with Starting Coins. Savings, ingredients, gold, and other assets are not included.");
        ...
        terms["players.analysis.expense_efficiency.desc"] = ("Menghitung bagian koin keluar yang dipakai untuk bahan pada pesanan yang selesai. Baca bersama laba pesanan.", "Calculates the share of outgoing coins used for ingredients in completed orders. Read it with order profit.");
        ...
        terms["players.analysis.risk_appetite.desc"] = ("Menggabungkan jumlah risiko yang diterima dan biayanya dibanding Koin Awal. Asuransi dinilai terpisah.", "Combines accepted risks and their cost compared with Starting Coins. Insurance is assessed separately.");
        terms["players.analysis.debt_discipline.title"] = ("Apakah pinjaman masih terkendali?", "Were loans kept under control?");
        terms["players.analysis.debt_discipline.desc"] = ("Membandingkan sisa pinjaman dengan Koin Saat Ini.", "Compares the remaining loan balance with Coins Held Now.");
        ...
        terms["players.analysis.goal_ambition.desc"] = ("Membandingkan target yang dicoba dan koin yang ditanam dengan kemampuan pemain.", "Compares attempted goals and invested coins with the player's capacity.");
        ...
        terms["players.analysis.meal_success.desc"] = ("Membandingkan pesanan yang selesai dengan pesanan yang dilewati.", "Compares completed orders with skipped orders.");
        terms["players.analysis.planning_horizon.title"] = ("Apakah pemain menyiapkan masa depan?", "Did the player prepare for the future?");
        terms["players.analysis.planning_horizon.desc"] = ("Menghitung bagian aksi untuk tabungan, target finansial, dan asuransi.", "Calculates the share of actions used for savings, financial goals, and insurance.");
        ...
        terms["players.support.formula.expense_efficiency"] = ("Belanja untuk Bahan Terpakai = Biaya Bahan Terpakai ÷ Total Koin Keluar × 100%.", "Spending on Used Ingredients = Used Ingredient Cost ÷ Total Outgoing Coins × 100%.");
        terms["players.support.formula.business_margin"] = ("Persentase Laba Pesanan = (Total Pendapatan Pesanan − Total Biaya Bahan) ÷ Total Pendapatan Pesanan × 100%.", "Order Profit Percentage = (Total Order Income − Total Ingredient Cost) ÷ Total Order Income × 100%.");
        ...
        terms["players.support.formula.risk_appetite"] = ("Tingkat Risiko yang Diambil = (Tingkat Penerimaan Risiko ÷ 100) × (Beban Biaya Risiko ÷ 100) × 100, dibatasi 0–100.", "Risk Taken Level = (Risk Acceptance Rate ÷ 100) × (Risk Cost Burden ÷ 100) × 100, capped at 0–100.");
        terms["players.support.formula.debt_leverage"] = ("Beban Utang terhadap Kas = Sisa Saldo Pinjaman Syariah ÷ Koin Saat Ini × 100%.", "Debt Burden Compared with Cash = Outstanding Loan Balance ÷ Coins Held Now × 100%.");
        ...
        terms["players.support.formula.goal_ambition_index"] = ("Keseriusan Mengejar Target = (Persentase Target yang Dicoba + Bagian Dana untuk Target) ÷ 2, dibatasi 0–100%.", "Goal Pursuit = (Goals Attempted Percentage + Share of Funds for Goals) ÷ 2, capped at 0–100%.");
        ...
        terms["players.support.formula.order_success"] = ("Pesanan yang Berhasil = Pesanan Selesai ÷ (Pesanan Selesai + Pesanan Dilewati) × 100%.", "Successful Orders = Completed Orders ÷ (Completed Orders + Skipped Orders) × 100%.");
        terms["players.support.formula.planning"] = ("Aksi untuk Masa Depan = (Aksi Menabung + Aksi Target Finansial + Aksi Membeli Premi Asuransi) ÷ Seluruh Aksi Pemain × 100%.", "Actions for the Future = (Savings Actions + Financial Goal Actions + Insurance Premium Actions) ÷ All Player Actions × 100%.");
        ...
        terms["players.raw.financial_goals_available_total"] = ("Jumlah Target yang Tersedia", "Available Goals");
        ...
        terms["players.raw.action_slots_unused"] = ("Jatah Aksi yang Tidak Dipakai", "Unused Action Allowance");
