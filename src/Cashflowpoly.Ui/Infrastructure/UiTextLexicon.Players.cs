...
internal static partial class UiTextLexicon
{
    private static partial void AddPlayers(Dictionary<string, (string Id, string En)> terms)
    {
        ...
        terms["players.analysis.goal_completion.result"] = ("{0} dari {1} jenis tujuan dalam katalog sudah dibeli.", "{0} of {1} goal types in the catalog have been purchased.");
        terms["players.support.formula.goal_completion"] = ("Persentase Target Berhasil Dibeli = Target Finansial Berhasil Dibeli ÷ Jenis Tujuan dalam Katalog × 100%. Tanpa katalog tujuan, hasil belum tersedia. Saldo tabungan tidak menunjukkan kepemilikan kartu.", "Goal Purchase Completion = Financial Goals Purchased ÷ Goal Types in Catalog × 100%. With no goal catalog, the result is unavailable. A savings balance does not indicate card ownership.");
        terms["players.metric.financial_goal_completion_percent"] = ("Persentase Target Berhasil Dibeli", "Goal Purchase Completion");
        terms["players.support.meaning.attempted_goals"] = ("Jumlah jenis tujuan yang telah dibeli; kolom lama ini tidak bertambah karena setoran tabungan.", "Number of goal types purchased; this legacy field does not increase with savings deposits.");
        terms["players.support.meaning.goal_completion"] = ("Jumlah jenis tujuan yang sudah dibeli dibandingkan seluruh jenis tujuan dalam katalog, dikalikan 100%. Setoran tabungan tidak memesan kartu atau menambah pembelian.", "Purchased goal types divided by all goal types in the catalog, multiplied by 100%. Deposits neither reserve cards nor add purchases.");
        terms["players.support.guide.goal_completion_all"] = ("100%: pemain sudah membeli seluruh jenis tujuan dalam katalog.", "100%: the player has purchased every goal type in the catalog.");
        terms["players.support.guide.goal_completion_none"] = ("0%: belum ada kartu tujuan yang dibeli, meskipun pemain mungkin sudah menabung.", "0%: no goal card has been purchased, even if the player has already saved.");
        terms["players.support.guide.goal_completion_partial"] = ("Di atas 0% dan di bawah 100%: pemain telah membeli sebagian jenis tujuan dalam katalog.", "Above 0% and below 100%: the player has purchased some goal types in the catalog.");
        ...
        terms["players.detail.empty_analytics"] = ("Data permainan pemain belum tersedia pada sesi ini. Pastikan aktivitas sudah terkirim, lalu muat ulang halaman.", "Player game data is not available for this session yet. Make sure activities have been sent, then reload the page.");
        ...
        terms["players.analysis.business_margin.title"] = ("Berapa persen pendapatan pesanan menjadi keuntungan?", "What percentage of order income became profit?");
        ...
        terms["players.analysis.goal_ambition.title"] = ("Berapa kartu tujuan finansial yang berhasil dibeli?", "How many financial goal cards were purchased?");
        terms["players.analysis.goal_ambition.desc"] = ("Kartu menjadi milik pemain yang lebih dulu mampu membayar penuh selama stok tersedia. Menabung menambah saldo tabungan pemain untuk membeli kartu tujuan mana pun; setoran tidak memesan kartu. Lihat jumlah kartu yang sudah dibeli, biaya pembelian, dan tabungan yang tersisa.", "The first player able to pay in full gets an available card. Deposits add to the player's savings, which can buy any goal card; they do not reserve a card. See purchased cards, purchase costs, and remaining savings.");
        ...
        terms["players.support.formula.goal_purchases"] = ("Target Finansial Berhasil Dibeli = jumlah kartu target yang pembeliannya sudah selesai. Total Biaya Pembelian Target Finansial = jumlah biaya pembelian kartu-kartu tersebut. Koin dalam Tabungan = tabungan awal + setoran − biaya pembelian yang dibayar dari tabungan.", "Financial Goals Purchased = number of goal cards whose purchase is complete. Total Financial Goal Purchase Cost = sum of the purchase costs of those cards. Coins in Savings = initial savings + deposits − purchases paid from savings.");
        ...
        terms["players.analysis.happiness_portfolio.desc"] = ("0% berarti poin kebahagiaan positif hanya berasal dari satu sumber; 100% berarti terbagi sama rata pada enam sumber dasar: kartu kebutuhan, bonus set, donasi, emas, pensiun, dan target finansial. Poin kebahagiaan awal dan hadiah misi menjadi sumber tambahan bila positif. Penalti tidak dihitung sebagai sumber poin kebahagiaan.", "0% means positive Happiness points come from just one source; 100% means they are evenly spread across six base sources: need cards, set bonuses, donations, gold, pension, and financial goals. Positive starting Happiness points and mission rewards count as additional sources. Penalties are excluded.");
        terms["players.analysis.happiness_portfolio.beginner.desc"] = ("0% berarti poin kebahagiaan positif hanya berasal dari satu sumber; 100% berarti terbagi sama rata pada lima sumber dasar: kartu kebutuhan, bonus set, donasi, emas, dan pensiun. Poin kebahagiaan awal dan hadiah misi menjadi sumber tambahan bila positif. Penalti tidak dihitung sebagai sumber poin kebahagiaan.", "0% means positive Happiness points come from just one source; 100% means they are evenly spread across five base sources: need cards, set bonuses, donations, gold, and pension. Positive starting Happiness points and mission rewards count as additional sources. Penalties are excluded.");
        ...
        terms["players.analysis.source.goal-ambition"] = ("Target Finansial Berhasil Dibeli berasal dari pembelian kartu yang dicatat instruktur. Total Biaya Pembelian Target Finansial adalah koin yang sudah dibayar untuk kartu tersebut. Koin dalam Tabungan adalah saldo milik pemain yang masih dapat digunakan untuk kartu tujuan lain yang tersedia. Tabungan tidak terikat atau memberi hak atas suatu kartu; pembelian lebih dahulu menentukan kepemilikan. Pembelian tetap tercatat jika poin kebahagiaan terkena penalti pinjaman.", "Financial Goals Purchased comes from card purchases recorded by the instructor. Total Financial Goal Purchase Cost is the amount already paid for those cards. Coins in Savings is the player's remaining balance available for other goal cards in stock. Savings are not earmarked and give no claim to a card; the first purchase determines ownership. Purchases remain recorded if a loan penalty affects Happiness Points.");
        ...
        terms["players.support.guide.goals"] = ("Bandingkan kartu yang sudah dibeli, biaya pembelian, dan tabungan pemain yang masih tersisa.", "Compare purchased cards, purchase costs, and the player's remaining savings.");
        ...
        terms["players.support.recommendation.productive_spending"] = ("Baca bersama Persentase Keuntungan Pesanan dan Bahan Tersisa untuk melihat apakah pembelian bahan sudah mendukung pesanan yang menghasilkan keuntungan.", "Read this with Order Profit Margin and Remaining Ingredients to see whether ingredient purchases supported profitable orders.");
        ...
        terms["players.support.guide.expense_efficiency"] = ("Dari setiap 100 koin yang keluar, nilai ini menunjukkan bagian untuk pembelian bahan. Nilai tinggi tidak otomatis berarti lebih untung; lihat Persentase Keuntungan Pesanan.", "For every 100 outgoing coins, this shows the share spent on ingredients. A higher value does not automatically mean more profit; check Order Profit Margin.");
        ...
        terms["players.support.guide.goals_complete"] = ("100%: biaya pembelian mencapai total harga seluruh jenis tujuan dalam katalog. Sisa tabungan ditampilkan terpisah.", "100%: purchase costs equal the total price of all goal types in the catalog. Remaining savings are shown separately.");
        terms["players.support.guide.goals_strong"] = ("67–99%: biaya pembelian mencapai setidaknya dua pertiga total harga jenis tujuan dalam katalog.", "67–99%: purchase costs reach at least two thirds of the total price of goal types in the catalog.");
        terms["players.support.guide.goals_moderate"] = ("34–67%: biaya pembelian mencapai sebagian total harga jenis tujuan dalam katalog, tetapi belum dua pertiga.", "34–67%: purchase costs reach part of the total catalog goal price, but less than two thirds.");
        terms["players.support.guide.goals_limited"] = ("Di bawah 34%: biaya pembelian kurang dari sepertiga total harga jenis tujuan dalam katalog.", "Below 34%: purchase costs are less than one third of the total catalog goal price.");
        ...
        terms["players.support.formula.business_margin"] = ("Persentase Keuntungan Pesanan = (Total Pendapatan Pesanan − Biaya Bahan Terpakai) ÷ Total Pendapatan Pesanan × 100%.", "Order Profit Margin = (Total Order Income − Used Ingredient Cost) ÷ Total Order Income × 100%.");
        ...
        terms["players.support.formula.goal_ambition_index"] = ("Porsi Biaya Pembelian Tujuan = Total Biaya Pembelian Target Finansial ÷ Total Harga Jenis Tujuan dalam Katalog × 100%. Hanya pembayaran kartu yang dihitung; saldo tabungan tidak memberi kepemilikan.", "Goal Purchase Cost Share = Total Financial Goal Purchase Cost ÷ Total Price of Catalog Goal Types × 100%. Only paid purchases count; savings do not grant ownership.");
        ...
        terms["players.support.formula.happiness_portfolio"] = ("Pemerataan Sumber Poin Kebahagiaan = [1 − jumlah (poin kebahagiaan tiap sumber ÷ total poin kebahagiaan positif)²] ÷ (1 − 1/n) × 100%. Enam sumber dasar: Poin Kebahagiaan Kartu Kebutuhan + Poin Kebahagiaan Bonus Set Kebutuhan + Poin Kebahagiaan dari Donasi + Poin Kebahagiaan Emas + Poin Kebahagiaan Dana Pensiun + Poin Kebahagiaan Target Finansial. Poin Kebahagiaan Awal dan Hadiah Poin Kebahagiaan Misi Koleksi menambah n masing-masing satu bila bernilai positif. Sumber dasar bernilai nol tetap dihitung; penalti dikecualikan. Belum tersedia jika tidak ada poin kebahagiaan positif.", "Happiness Point Source Balance = [1 − sum of (Happiness points per source ÷ total positive Happiness points)²] ÷ (1 − 1/n) × 100%. Six base sources: Need Card Happiness Points + Need Set Bonus Happiness Points + Happiness Points from Donations + Gold Happiness Points + Pension Happiness Points + Financial Goal Happiness Points. Starting Happiness Points and Collection Mission Reward Happiness Points each add one to n when positive. Zero-valued base sources are included; penalties are excluded. Unavailable when there are no positive Happiness points.");
        terms["players.support.formula.happiness_portfolio.beginner"] = ("Pemerataan Sumber Poin Kebahagiaan = [1 − jumlah (poin kebahagiaan tiap sumber ÷ total poin kebahagiaan positif)²] ÷ (1 − 1/n) × 100%. Lima sumber dasar: Poin Kebahagiaan Kartu Kebutuhan + Poin Kebahagiaan Bonus Set Kebutuhan + Poin Kebahagiaan dari Donasi + Poin Kebahagiaan Emas + Poin Kebahagiaan Dana Pensiun. Poin Kebahagiaan Awal dan Hadiah Poin Kebahagiaan Misi Koleksi menambah n masing-masing satu bila bernilai positif. Sumber dasar bernilai nol tetap dihitung; penalti dikecualikan. Belum tersedia jika tidak ada poin kebahagiaan positif.", "Happiness Point Source Balance = [1 − sum of (Happiness points per source ÷ total positive Happiness points)²] ÷ (1 − 1/n) × 100%. Five base sources: Need Card Happiness Points + Need Set Bonus Happiness Points + Happiness Points from Donations + Gold Happiness Points + Pension Happiness Points. Starting Happiness Points and Collection Mission Reward Happiness Points each add one to n when positive. Zero-valued base sources are included; penalties are excluded. Unavailable when there are no positive Happiness points.");
        ...
        terms["players.details.raw_subtitle"] = ("Data permainan divisualkan per kelompok. Ringkasan gabungan tampil sebagai batang, sedangkan urutan perubahan tampil sebagai garis. Klik atau ketuk batang atau titik untuk melihat fungsi, asal data, dan nilainya.", "Gameplay data is visualized by group. Combined summaries use bars, while changes over time use lines. Click or tap a bar or point to view its function, source, and value.");
        terms["players.details.derived_title"] = ("Hasil Analisis Permainan", "Gameplay Analysis Results");
        terms["players.details.derived_subtitle"] = ("Hasil analisis disajikan per kelompok: perbandingan utama dalam batang dan perubahan berurutan dalam garis. Klik atau ketuk batang atau titik untuk melihat fungsi, asal data, dan nilainya.", "Analysis results are organized by group: key comparisons use bars and sequential changes use lines. Click or tap a bar or point to view its function, source, and value.");
        ...
        terms["players.details.derived.financial.desc"] = ("Perbandingan koin, pemerataan pendapatan, persentase pengeluaran untuk bahan, dan persentase keuntungan pesanan.", "Coin comparison, income balance, ingredient spending share, and order profit margin.");
        ...
        terms["players.metric.business_profit_margin"] = ("Persentase Keuntungan Pesanan", "Order Profit Margin");
        ...
        terms["players.raw.financial_goals_attempted"] = ("Jenis Tujuan Dibeli (Kolom Lama)", "Purchased Goal Types (Legacy)");
        terms["players.raw.financial_goals_available_total"] = ("Jenis Tujuan dalam Katalog", "Goal Types in Catalog");
        ...
        terms["players.raw.financial_goals_coins_total_invested"] = ("Total Biaya Pembelian Target Finansial", "Total Financial Goal Purchase Cost");
        terms["players.raw.financial_goals_incomplete_coins_wasted"] = ("Dana Terikat Tujuan (Kolom Lama)", "Earmarked Goal Funds (Legacy)");
        ...
        terms["players.metric.meal_order_profit_margin_percent"] = ("Persentase Keuntungan Pesanan", "Order Profit Margin");
        ...
        terms["players.metric.financial_goal_progress_percent"] = ("Porsi Biaya Pembelian Tujuan", "Goal Purchase Cost Share");
        ...
        terms["players.metric.coins_committed_to_goals"] = ("Total Biaya Pembelian Target Finansial", "Total Financial Goal Purchase Cost");
        terms["players.metric.attempted_goal_target_total"] = ("Total Harga Jenis Tujuan dalam Katalog", "Total Price of Catalog Goal Types");
        ...
        terms["players.metric.initial_happiness_points"] = ("Poin Kebahagiaan Awal", "Starting Happiness Points");
        terms["players.metric.mission_reward_points"] = ("Hadiah Poin Kebahagiaan Misi Koleksi", "Collection Mission Reward Happiness Points");
        ...
        terms["players.group.meal_order_profit_margin_components"] = ("Data Persentase Keuntungan Pesanan", "Order Profit Margin Inputs");
        ...
        terms["players.group.financial_goal_progress_components"] = ("Data Biaya Pembelian Tujuan", "Goal Purchase Cost Inputs");
        ...
        terms["players.support.guide.ingredient_use_low"] = ("Di bawah 60%: kurang dari 60% bahan yang diperoleh digunakan pada pesanan selesai. Periksa bahan tersisa dan terbuang.", "Below 60%: less than 60% of collected ingredients were used in completed orders. Check remaining and wasted ingredients.");
