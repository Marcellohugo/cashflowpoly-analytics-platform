...
internal static partial class UiTextLexicon
{
    private static partial void AddSessions(Dictionary<string, (string Id, string En)> terms)
    {
        ...
        terms["sessions.created"] = ("Belum dimulai", "Not started");
        ...
        terms["sessions.tips.instructor.step2"] = ("Tekan Rincian untuk memeriksa set aturan aktif, hasil permainan, dan urutan aktivitas sesi tersebut.", "Select Details to review the active ruleset, game results, and activity order for that session.");
        ...
        terms["sessions.tips.player.step2"] = ("Tekan Rincian untuk melihat poin kebahagiaan, arus kas, posisi permainan, dan aktivitas Anda.", "Select Details to review your happiness score, cashflow, game position, and activity.");
        ...
        terms["sessions.live_log"] = ("Daftar Sesi", "Session List");
        ...
        terms["sessions.detail.players_subtitle"] = ("Bandingkan komponen dan total Poin Kebahagiaan setiap pemain dalam satu tabel.", "Compare the components and each player's total Happiness Score in one table.");
        ...
        terms["sessions.score.elements_title"] = ("Komponen Poin Kebahagiaan", "Happiness Score Components");
        ...
        terms["status.session.created"] = ("Belum dimulai", "Not started");
