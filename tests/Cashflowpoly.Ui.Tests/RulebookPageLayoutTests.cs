...
public sealed class RulebookPageLayoutTests
{
    ...
    public void RulebookView_ShouldUseStructuredReadableLayout()
    {
        ...
        Assert.Contains("rulebook-mode-flow-grid", viewContent, StringComparison.Ordinal);
        Assert.Contains("Mode Pemula", viewContent, StringComparison.Ordinal);
        Assert.Contains("Mode Mahir", viewContent, StringComparison.Ordinal);
        Assert.Contains("rulebook-flow-map", viewContent, StringComparison.Ordinal);
        Assert.Contains("rulebook-stage-grid", viewContent, StringComparison.Ordinal);
        Assert.Contains("rulebook-reference-table", viewContent, StringComparison.Ordinal);
    ...
    public void SiteCss_ShouldGiveRulebookResponsiveWideScreenLayout()
    {
        ...
        Assert.Contains(".rulebook-stage-grid", cssContent, StringComparison.Ordinal);
        ...
        Assert.Contains(".rulebook-stage-card > div", cssContent, StringComparison.Ordinal);
        ...
        Assert.Contains(".rulebook-mode-flow-grid", cssContent, StringComparison.Ordinal);
        Assert.Contains(".rulebook-table-shell table", cssContent, StringComparison.Ordinal);
        Assert.Contains("width: 100% !important;", cssContent, StringComparison.Ordinal);
        Assert.Contains(".rulebook-reference-table", cssContent, StringComparison.Ordinal);
